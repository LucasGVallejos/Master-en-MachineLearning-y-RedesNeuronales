...
#De Cuantos A�os tenemos informacion?
years = data['Year'].unique().tolist()
print('A�os -> ', len(years))
...
#C�mo cambiaron las emisiones a lo largo del tiempo dentro de nuestro pais
...
plt.ylabel('Emisiones de CO2 (Toneladas M�tricas per capita)')
...
#Seleccionamos todos los paises del a�o 2011
hist_year = 2011
